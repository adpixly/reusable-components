        ...
        <div className='w-full max-w-xs mx-auto shrink-0'>
          <div className='relative'>
            ...
            <div className='space-y-3'>
              <Link
                href='/login'
                className='btn text-gray-100 bg-gray-700 hover:bg-gray-600 dark:text-gray-800 dark:bg-gray-100 dark:hover:bg-white w-full'>
                Log In
              </Link>
              <Link
                href='/signin'
                className='btn text-gray-100 bg-gray-900 hover:bg-gray-800 dark:text-gray-800 dark:bg-orange-200 dark:hover:bg-orange-100 w-full'>
                Create an Account
              </Link>
            </div>
          </div>
      ...
      <div className='max-w-3xl mx-auto'>
        <div className='text-center'>
          ...
          <ul className='flex justify-center -space-x-2 mb-4'>
            <li>
              <Image className='rounded-full' src='/images/avatar-01.jpg' width={32} height={32} alt='Avatar 01' />
            </li>
            <li>
              <Image className='rounded-full' src='/images/avatar-02.jpg' width={32} height={32} alt='Avatar 02' />
            </li>
            <li>
              <Image className='rounded-full' src='/images/avatar-03.jpg' width={32} height={32} alt='Avatar 03' />
            </li>
            <li>
              <Image className='rounded-full' src='/images/avatar-04.jpg' width={32} height={32} alt='Avatar 04' />
            </li>
            <li>
              <Image className='rounded-full' src='/images/avatar-05.jpg' width={32} height={32} alt='Avatar 05' />
            </li>
          </ul>
          <p className='text-sm text-gray-500'>
            Join the <span className='text-gray-700 dark:text-gray-200 font-medium'>2.000+</span> members who have
            already signed up.
          </p>
        </div>
      </div>
