...
const AE: SelectOption = {
  ...
  label: { mainText: 'United Arab Emirates (‫الإمارات العربية المتحدة‬‎)', secondaryText: '+ 971' },
  value: '+ 971'
}
...
const GB: SelectOption = {
  ...
  label: { mainText: 'United Kingdom', secondaryText: '+ 44' },
  value: '+ 44'
}
...
const AX: SelectOption = {
  ...
  label: { mainText: 'Åland Islands', secondaryText: '+ 358' },
  value: '+ 358'
}
